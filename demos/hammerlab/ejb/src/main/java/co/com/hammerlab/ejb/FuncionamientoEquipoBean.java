 ...
 */
@Stateless
public class FuncionamientoEquipoBean {
         ...
         */
        public void save(FuncionamientoEquipo obj) {
         ...
         */
        public void update(FuncionamientoEquipo obj) {
        ...
        public void delete(Long idObj) {
                FuncionamientoEquipo obj = entityManager.find(FuncionamientoEquipo.class, idObj);
         ...
         */
        public FuncionamientoEquipo getByID(Long idObj) {
                return entityManager.find(FuncionamientoEquipo.class, idObj);
        }
       /**
         * Consulta todos los registro de un objeto
         * @return Lista de objetos 
         */
        public List< FuncionamientoEquipo > getAll() {
                return entityManager.createNamedQuery("funcionamientoEquipo.getAll", FuncionamientoEquipo.class).getResultList();
        }
